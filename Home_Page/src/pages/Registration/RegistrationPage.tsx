...
import { Shield, BarChart3, Heart, ArrowLeft } from 'lucide-react';
    ...
    <div className="flex h-screen w-full overflow-hidden">
      ...
      <div className="w-[60%] overflow-y-auto bg-ivory flex flex-col">
        ...
        <nav ref={navbarRef} className="flex items-center justify-between px-10 py-5 border-b border-sand bg-ivory/90 backdrop-blur-md sticky top-0 z-20 opacity-0">
          <Link to="/" className="flex items-center gap-2 text-xl font-bold text-coffee tracking-tight hover:text-burnt transition-colors no-underline">
          ...
          <div className="flex items-center gap-8">
            ...
            <Link to="/" className="bg-coffee hover:bg-coffee/90 transition-colors text-white rounded-full px-6 py-2.5 text-sm font-medium no-underline">
              Sign In
            </Link>
          </div>
        </nav>
